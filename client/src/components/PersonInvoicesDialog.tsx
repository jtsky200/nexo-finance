  ...
  return (
    <>
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent className="max-w-[800px] w-[95vw] max-h-[85vh] p-0 gap-0 overflow-hidden">
          {/* Header */}
          ...
          <div className="px-6 py-5 overflow-y-auto flex-1">
            ...
            {/* Invoice List */}
            <h3 className="font-semibold mb-3">Rechnungen</h3>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <h4 className="font-medium truncate">{invoice.description}</h4>
                            <Badge 
                              variant="secondary"
