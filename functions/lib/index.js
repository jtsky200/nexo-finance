...
exports.trpc = exports.analyzeProductImage = exports.searchProductInfo = exports.getWeatherHistory = exports.saveWeather = void 0;
    ...
    if (dueDate) {
        ...
        if (validatedType === 'termin') {
            ...
            if (dueDateOnly < today) {
                throw new https_1.HttpsError('invalid-argument', 'Termine können nicht in der Vergangenheit erstellt werden');
            }
        }
    }
    else {
...
exports.searchProductInfo = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.analyzeProductImage = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
